...
async function GET(req) {
    ...
    const mine = rows.filter((n)=>n.Employee_ID === session.userId).sort((a, b)=>new Date(b.Created_At).getTime() - new Date(a.Created_At).getTime()).slice(0, limit);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22985e92._.js.map