...
"[project]/src/app/api/weekly/team-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const [employees, reflections, checkins] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Employees"),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Reflections"),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Checkins")
    ]);
    // Filter team members
    let team;
    if (session.role === "manager") {
        team = employees.filter((e)=>e.Manager_ID === session.userId && e.Status === "active" && e.Employee_ID !== session.userId);
    } else {
        // HR / MD see all active employees
        team = employees.filter((e)=>e.Status === "active" && e.Employee_ID !== session.userId);
    }
    const reflectionMap = new Map();
    reflections.filter((r)=>r.Week_Start_Date === week).forEach((r)=>reflectionMap.set(r.Employee_ID, r));
    const checkinMap = new Map();
    checkins.filter((c)=>c.Week_Start_Date === week).forEach((c)=>checkinMap.set(c.Employee_ID, c));
    const status = team.map((e)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__662e38e5._.js.map