...
async function POST(req) {
    ...
    if (session.role === "employee") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Forbidden: only managers can assign tasks"
        }, {
            status: 403
        });
    }
    ...
    if (emp.Employee_Type !== "blue_collar") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Tasks can only be assigned to blue-collar employees"
        }, {
            status: 400
        });
    }
    ...
    const seq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNextSeq"])("Tasks");
    const taskId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])("TASK", seq);
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Tasks", task);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42937bae._.js.map