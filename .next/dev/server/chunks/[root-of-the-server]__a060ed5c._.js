...
"[project]/src/app/api/weekly/checkin/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const week = req.nextUrl.searchParams.get("week") ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWeekStart"])();
    ...
    if (!isManagerRole) {
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Checkins");
        const checkin = rows.find((r)=>r.Employee_ID === session.userId && r.Week_Start_Date === week) ?? null;
        if (!checkin) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            checkin: null
        });
    ...
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Checkins");
    if (employeeId) {
        const checkin = rows.find((r)=>r.Employee_ID === employeeId && r.Week_Start_Date === week) ?? null;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            checkin
        });
    }
    // All check-ins by this manager this week
    const mine = rows.filter((r)=>r.Manager_ID === session.userId && r.Week_Start_Date === week);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        checkins: mine
    });
}
async function POST(req) {
    ...
    if (!employee_id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "employee_id is required"
    }, {
        status: 400
    });
    if (!main_thing_on_mind?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "main_thing_on_mind is required"
    }, {
        status: 400
    });
    if (!committed_to?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "committed_to is required"
    }, {
        status: 400
    });
    if (!did_well?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "did_well is required"
    }, {
        status: 400
    });
    if (!improve?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "improve is required"
    }, {
        status: 400
    });
    // Validate employee exists and reports to this manager (skip for hr/md)
    const employees = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Employees");
    const emp = employees.find((e)=>e.Employee_ID === employee_id);
    if (!emp) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const week = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWeekStart"])();
    // Employee must have submitted a reflection this week
    const reflections = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Reflections");
    const reflection = reflections.find((r)=>r.Employee_ID === employee_id && r.Week_Start_Date === week);
    if (!reflection) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Employee has not submitted a reflection for this week yet"
        }, {
            status: 422
        });
    }
    // Duplicate check
    const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Checkins");
    const dup = existing.find((r)=>r.Manager_ID === session.userId && r.Employee_ID === employee_id && r.Week_Start_Date === week);
    if (dup) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Check-in already submitted for this employee this week"
    }, {
        status: 409
    });
    const seq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNextSeq"])("Weekly_Checkins");
    const checkinId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])("CHK", seq);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Weekly_Checkins", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a060ed5c._.js.map