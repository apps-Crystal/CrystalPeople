...
"[project]/src/app/api/monthly/manager-score/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (session.role === "employee") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Forbidden: employees cannot score team members"
        }, {
            status: 403
        });
    }
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isWindowOpen"])(session.role, config)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Scoring window is currently closed"
        }, {
            status: 400
        });
    }
    const body = await req.json();
    const { employee_id, scores, comments, review_notes, next_month_focus } = body;
    ...
    const cycle = cycles.find((c)=>c.Employee_ID === employee_id && c.Month === month && c.Year === year);
    if (!cycle || cycle.Status !== "self_scored") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Employee must complete self-assessment first"
        }, {
            status: 400
        });
    }
    // Validate all dimension scores
    const empGoals = goals.filter((g)=>g.Employee_ID === employee_id && g.Month === month && g.Year === year);
    const empTasks = tasks.filter((t)=>t.Employee_ID === employee_id);
    const dimensions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getScoreDimensions"])(employee, empGoals, empTasks);
    ...
    const flaggedDimensions = dimensions.filter((d)=>{
        const self = selfScores[d.key];
        const mgr = scores[d.key];
        return self !== undefined && mgr !== undefined && Math.abs(self - mgr) > 1;
    }).map((d)=>d.key);
    const lockedAverage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeAverage"])(Object.values(scores));
    const scoresJson = JSON.stringify(scores);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowWhere"])("Review_Cycles", "Cycle_ID", cycle.Cycle_ID, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e04be0ee._.js.map