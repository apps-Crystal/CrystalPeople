...
async function GET(req) {
    ...
    if (session.role === "employee") {
        ...
        if (employeeId !== session.userId) {
            const employees = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cachedReadSheet"])("Employees");
    ...
    const goals = allGoals.filter((g)=>g.Employee_ID === employeeId && g.Month === month && g.Year === year);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        goals
    });
}
async function POST(req) {
    ...
    const allGoals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Goals");
    const activeGoalsCount = allGoals.filter((g)=>g.Employee_ID === targetEmployeeId && g.Month === String(config.current_month) && g.Year === String(config.current_year) && g.Status === "active").length;
    ...
    const seq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNextSeq"])("Goals");
    const goalId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])("GOAL", seq);
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Goals", goal);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd5c334c._.js.map