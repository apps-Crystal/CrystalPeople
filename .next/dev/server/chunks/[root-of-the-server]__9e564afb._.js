...
"[project]/src/app/api/goals/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    ...
    const allGoals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Goals");
    const goal = allGoals.find((g)=>g.Goal_ID === id);
    if (!goal) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Goal not found"
    }, {
        status: 404
    });
    // Authorization: employee who owns goal, their manager, hr, or md
    const canEdit = session.role === "hr" || session.role === "md" || goal.Employee_ID === session.userId || session.role === "manager" && goal.Manager_ID === session.userId;
    ...
    const lockedCycle = cycles.find((c)=>c.Employee_ID === goal.Employee_ID && c.Month === goal.Month && c.Year === goal.Year && c.Status === "locked");
    if (lockedCycle) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Cannot edit goals in a locked review cycle"
        }, {
            status: 400
        });
    }
    ...
    if (status === "dropped") {
        if (!drop_reason || drop_reason.trim().length < 10) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Drop reason must be at least 10 characters"
            }, {
                status: 400
            });
        }
    ...
    const updates = {};
    if (title !== undefined) {
        if (title.trim().length < 5) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (description !== undefined) {
        if (description.trim().length < 10) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowWhere"])("Goals", "Goal_ID", id, updates);
    ...
    // Return updated goal
    const refreshed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Goals");
    const updated = refreshed.find((g)=>g.Goal_ID === id) ?? {
        ...goal,
        ...updates
    };
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(_req, { params }) {
    ...
    if (session.role !== "hr" && session.role !== "md") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Forbidden: only HR and MD can delete goals"
        }, {
            status: 403
        });
    }
    ...
    if (goal.Self_Score || goal.Manager_Score) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Cannot delete a goal that has been scored"
        }, {
            status: 400
        });
    }
    // Mark as dropped (Google Sheets doesn't support row deletion easily — use status="dropped")
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowWhere"])("Goals", "Goal_ID", id, {
        Status: "dropped",
        Drop_Reason: "Deleted by HR/MD"
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invalidateCache"])("Goals");
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e564afb._.js.map