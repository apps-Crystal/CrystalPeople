...
"[project]/src/app/api/notifications/read/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req) {
    ...
    if (!notification_ids?.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "notification_ids is required"
    }, {
        status: 400
    });
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Notifications");
    let updated = 0;
    for (const id of notification_ids){
        const notif = rows.find((n)=>n.Notification_ID === id);
        if (!notif || notif.Employee_ID !== session.userId) continue;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowWhere"])("Notifications", "Notification_ID", id, {
            Status: "read"
        });
        updated++;
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90806ade._.js.map