...
"[project]/src/app/api/weekly/reflection/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Reflections");
    const reflection = rows.find((r)=>r.Employee_ID === session.userId && r.Week_Start_Date === week) ?? null;
...
async function POST(req) {
    ...
    if (!accomplishments?.trim() || accomplishments.trim().length < 10) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Accomplishments must be at least 10 characters"
        }, {
            status: 400
        });
    }
    if (!next_week_plan?.trim() || next_week_plan.trim().length < 10) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Next week plan must be at least 10 characters"
        }, {
            status: 400
        });
    }
    ...
    const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Reflections");
    ...
    const seq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNextSeq"])("Weekly_Reflections");
    const reflectionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])("REF", seq);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Weekly_Reflections", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__243ab520._.js.map