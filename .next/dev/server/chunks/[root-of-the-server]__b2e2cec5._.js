...
"[project]/src/app/api/monthly/lock-cycle/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const label = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["monthLabel"])(Number(cycle.Month), Number(cycle.Year)) || `${cycle.Month}/${cycle.Year}`;
    const avg = cycle.Locked_Average ? ` with a score of ${Number(cycle.Locked_Average).toFixed(2)}` : "";
    void (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNotification"])(cycle.Employee_ID, "manual", `Your ${label} review has been locked${avg}.`).catch(()=>{});
    const updatedCycle = {
        ...cycle,
        Status: "locked"
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2e2cec5._.js.map