...
"[project]/src/app/api/weekly/acknowledge/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const checkins = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Weekly_Checkins");
    let checkin;
    if (checkin_id) {
    ...
    if (!checkin) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "No check-in found for this employee"
        }, {
            status: 404
        });
    }
    ...
    const reflection = reflections.find((r)=>r.Employee_ID === session.userId && r.Week_Start_Date === checkin.Week_Start_Date);
    if (!reflection) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowWhere"])("Weekly_Reflections", "Reflection_ID", reflection.Reflection_ID, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8e7ba192._.js.map