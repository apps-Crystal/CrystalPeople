...
"[project]/src/app/api/employees/bulk-import/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    for(let i = 0; i < rows.length; i++){
        ...
        if (!VALID_ROLES.includes(r.role)) {
            errors.push({
                row: rowNum,
                error: `Invalid role "${r.role}". Must be: ${VALID_ROLES.join(", ")}`
            });
            continue;
        }
        if (!VALID_TYPES.includes(r.employee_type)) {
            errors.push({
                row: rowNum,
                error: `Invalid employee_type "${r.employee_type}". Must be: ${VALID_TYPES.join(", ")}`
            });
            continue;
        }
        if (emailSet.has(emailLower)) {
            errors.push({
                row: rowNum,
                error: `Email already exists: ${r.email}`
            });
            continue;
        }
        try {
            ...
            const hash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(r.password);
            ...
            if (r.role === "manager" || r.role === "hr" || r.role === "md") {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Managers", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc2a3607._.js.map