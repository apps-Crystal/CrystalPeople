...
async function PATCH(req, { params }) {
    ...
    for (const field of EDITABLE_FIELDS){
        ...
        if (value !== undefined && String(value) !== String(emp[field] ?? "")) {
    ...
    if (body.new_password) {
        updates["Password_Hash"] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(body.new_password);
        if (body.reset_first_login) updates["First_Login_Done"] = "FALSE";
        orgChanges.push({
            field: "Password_Hash",
            old: "[hashed]",
            new: "[new hash set by HR]"
        });
    }
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowWhere"])("Employees", "Employee_ID", id, updates);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c72bfb38._.js.map