...
"[project]/src/lib/org-changes.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function appendOrgChange(params) {
    const seq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNextSeq"])("Org_Changes");
    const changeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])("CHG", seq);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Org_Changes", {
        Change_ID: changeId,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sheets.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$org$2d$changes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/org-changes.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    ...
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Employees");
    let filtered = rows.filter((r)=>r.Employee_ID); // skip blank rows
    if (search) {
        filtered = filtered.filter((r)=>r.Name?.toLowerCase().includes(search) || r.Email?.toLowerCase().includes(search) || r.Employee_ID?.toLowerCase().includes(search) || r.Department?.toLowerCase().includes(search));
    }
    ...
    const managerMap = {};
    rows.forEach((r)=>{
        if (r.Employee_ID) managerMap[r.Employee_ID] = r.Name;
    });
    ...
    const departments = [
        ...new Set(rows.filter((r)=>r.Department).map((r)=>r.Department))
    ].sort();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        employees: safe,
        total: safe.length,
...
async function POST(req) {
    ...
    if (!name || !email || !department || !role || !employee_type || !join_date || !password) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Missing required fields: name, email, department, role, employee_type, join_date, password"
        }, {
            status: 400
        });
    }
    ...
    if (!validRoles.includes(role)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Invalid role"
    }, {
        status: 400
    });
    if (!validTypes.includes(employee_type)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Invalid employee_type"
    }, {
        status: 400
    });
    // Check duplicate email
    const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readSheet"])("Employees");
    ...
    // Generate ID
    const seq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNextSeq"])("Employees");
    const employeeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])("EMP", seq);
    const hash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
    const now = new Date().toISOString();
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendRowByFields"])("Employees", {
    ...
    if (role === "manager" || role === "hr" || role === "md") {
        const { appendRowByFields: append } = await __turbopack_context__.A("[project]/src/lib/sheets.ts [app-route] (ecmascript, async loader)");
        await append("Managers", {
            Manager_ID: employeeId,
            Employee_ID: employeeId
        });
    }
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$org$2d$changes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendOrgChange"])({
        employeeId,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sheets$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invalidateCache"])("Employees");
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
        employeeId
    }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f29757a1._.js.map